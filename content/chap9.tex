...
$\sigma_i^2\mid\mu_i\sim IG(\alpha_i,\beta_i),\qquad \alpha_i=\alpha_{i-1}+n/2,\qquad \beta_i=\beta_{i-1}+\dfrac12\sum_{j=1}^n(x_j-\mu_i)^2$.
...
$x_i=\Delta\log S_i=\mu\Delta t+\sigma\Delta W_i+Y_i\Delta N_i,\qquad P(\Delta N_i=1)=\lambda\Delta t$.
